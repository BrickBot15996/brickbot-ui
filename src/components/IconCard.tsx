export function IconCard({ children }: { children: React.ReactElement }) {
  return (
    <div className="h-auto w-auto transition-colors duration-200 cursor-pointer group relative bg-(--border) hover:bg-(--border-light) active:bg-(--border-light) p-[1rem]">
